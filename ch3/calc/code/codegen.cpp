...
public:
    ...
    void run(AST *Tree) {
        ...
        Function *MainF = Function::Create(MainFty, GlobalValue::ExternalLinkage, "main", M);
        BasicBlock *BB = BasicBlock::Create(M->getContext(), "entry", MainF);
    ...
    virtual void visit(WithDecl &Node) override {
        ...
        for (auto I = Node.begin(), E = Node.end(); I != E; ++ I) {
            ...
            GlobalVariable *Str = new GlobalVariable(*M, StrText->getType(), true, GlobalValue::PrivateLinkage, StrText, Twine(Var).concat(".str"));
